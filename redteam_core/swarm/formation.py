...
SWARM_SCENARIOS = {
    "S101": ("swarm_leader_spoof", "편대 리더 스푸핑·하이재킹", "T0856",
             "리더 보고메시지 위장 → 전 편대가 rogue 리더 추종"),
    "S102": ("swarm_consensus_poison", "군집 합의(Consensus) 포이즈닝", "T0832",
             "Byzantine 거짓상태 주입 → 분산합의 붕괴(집단 오판)"),
    "S103": ("swarm_collision_induce", "상대위치 스푸핑 충돌 유도", "T0806",
             "멤버간 상대항법 스푸핑 → 공중충돌 유발"),
    "S104": ("swarm_formation_scatter", "대형 분산/이탈 명령 주입", "T0855",
             "비인가 scatter 명령 → 편대 분열(임무 붕괴)"),
    "S105": ("swarm_sybil_inject", "Sybil 위장 멤버 주입", "T0859",
             "가짜 스웜 노드 주입 → 투표·조정 교란"),
    "S106": ("swarm_flocking_tamper", "flocking 규칙 변조(분리/정렬/응집)", "T0836",
             "군집 규칙 파라미터 변조 → 창발적 혼돈"),
    "S107": ("swarm_command_replay", "스웜 명령 리플레이/증폭", "T0857",
             "1:N 명령 재생 → 전 멤버 동시 오작동"),
    "S108": ("swarm_mesh_partition", "메시 파티션(군집 고립·분단)", "T0814",
