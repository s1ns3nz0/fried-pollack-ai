...
SCENARIO_EXEC = {
    ...
    "S2": ("mavlink", {"frame": "command", "cmd": _MODE, "params": [1, 3]}),
    "S4": ("http", {"stub": "pgse", "path": "/preflight/check", "body": {"firmware_hash": "deadbeef", "sbom_ok": False}}),
    "S5": ("mavlink", {"frame": "param", "id": "ARMING_CHECK", "val": 0}),
    "S6": ("http", {"stub": "auth", "path": "/login", "body": {"username": "operator-01", "password": "x"}, "repeat": 12}),
    "S11": ("http", {"stub": "weapon", "path": "/arm", "body": {"action": "ARM", "armed_by": "operator-01"}}),
    "S12": ("http", {"stub": "mps", "path": "/approve", "body": {"planner": "op1", "approver": "op1"}}),
    "S13": ("http", {"stub": "cyber", "path": "/posture/set", "body": {"level": "LOW"}}),
    "S14": ("http", {"stub": "ti", "path": "/indicator", "body": {"indicator": "203.0.113.66", "source": "rogue"}}),
    "S15": ("http", {"stub": "c4i", "path": "/order", "body": {"order": "RETASK", "hour": 3}}),
    "S17": ("exfil", {"kind": "sar_coords"}),
    "S18": ("mavlink", {"frame": "command", "cmd": _ARM, "params": [1]}),
    "S19": ("mavlink", {"frame": "param", "id": "FS_THR_ENABLE", "val": 0}),
    "S21": ("persist", {}),
    "S23": ("container", {"ns": "ground", "action": "delete pod gcs-qgc --force"}),
    "S25": ("container", {"ns": "sitl", "action": "exec av-muav-0 -- stress --cpu 8"}),
    "S26": ("container", {"ns": "link", "action": "exec datalink-los -- add-endpoint 10.0.0.99:14550"}),
    "S30": ("emso", {"action": "gnss_spoof", "geom": {"spoof_eirp_dbm": 20, "spoof_dist_m": 100, "freq_mhz": 1575.42}}),
    "S31": ("emso", {"action": "jam", "freq": 2437}),
    "S32": ("ai", {"kind": "prompt_injection"}),
    "S33": ("ai", {"kind": "model_extraction"}),
    "S35": ("exfil", {"kind": "bulk_imagery"}),
    "S36": ("exfil", {"kind": "staged"}),
    "S37": ("exfil", {"kind": "staged"}),
    "S38": ("exfil", {"kind": "crypto_key"}),
}
